...
from application.use_cases.list_orders import ListOrdersUsecase
...
class TestListOrders(TestCase):
    def test_list_orders_successfully(self):
        ...
        use_case = ListOrdersUsecase(beers_stock_repository=beers_repo, orders_repository=orders_repo)
        result = use_case.execute()

        orders_repo.list.assert_called_once()
